...
\begin{document}
	...
	\begin{itemize}
		\item Led design of a new \textbf{S-band communication architecture}, integrating flight-like hardware and simulation to reestablish links with lost-communication satellites.
	...
	\begin{itemize}
		\item Implemented a UKF with range iteration and least-squares orbit determination methods for \textbf{relative orbit determination using angles-only measurements}
		\item Performed Monte Carlo analysis on relative orbits to identify challenging observability scenarios and refine the estimation algorithm
		\item Programmed and developed unit tests for the \textbf{\emph{Lambert Solver}} to be utilized with \textbf{\emph{Initial Orbit Determination (IOD)}}
	\end{itemize}
