...
% Group A data
data_PC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [1.0] Introduction and Rocket Hardware.xlsx', 'Sheet', 'PC');
data_MC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [1.0] Introduction and Rocket Hardware.xlsx', 'Sheet', 'MC');
data_EC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [1.0] Introduction and Rocket Hardware.xlsx', 'Sheet', 'EC');

% Group B data
data_PC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [1.0] Introduction and Rocket Hardware.xlsx', 'Sheet', 'PC');
data_MC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [1.0] Introduction and Rocket Hardware.xlsx', 'Sheet', 'MC');
data_EC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [1.0] Introduction and Rocket Hardware.xlsx', 'Sheet', 'EC');

sol = [4, 4, 1, 2, 2, 4, 1, 1100]';
...
ylim([-15, 40]) % Adjust the y-axis limit as needed
legend('Group A', 'Group B', 'FontSize', 24) 

sgtitle('Introduction and Rocket Hardware Comparison', 'FontSize', 24, 'FontName', 'Times New Roman')

% Add bar values on top of the bars with the Greek letter delta
for i = 1:length(time)
    text(time(i), -6, sprintf('\\Delta=%.2f', mean_val_diff_GA(i)), ...
        'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom', 'FontSize', 14, 'Color', 'b', 'Interpreter', 'tex');
    text(time(i), -8, sprintf('\\Delta=%.2f', mean_val_diff_GB(i)), ...
