...
data_PC_GA_mod_1 = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [1.0] Introduction and Rocket Hardware.xlsx', 'Sheet', 'PC');
data_PC_GA_mod_2 = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [2.0] Fundamentals of Rocketry.xlsx', 'Sheet', 'PC');
data_PC_GA_mod_3 = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [3.0] Modeling Rocket Mechanics.xlsx', 'Sheet', 'PC');
data_PC_GA_mod_4 = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [4.0] Analysis.xlsx', 'Sheet', 'PC');

% Group B Module 1-4 Data
data_PC_GB_mod_1 = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [1.0] Introduction and Rocket Hardware.xlsx', 'Sheet', 'PC');
data_PC_GB_mod_2 = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [2.0] Fundamentals of Rocketry.xlsx', 'Sheet', 'PC');
data_PC_GB_mod_3 = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [3.0] Modeling Rocket Mechanics.xlsx', 'Sheet', 'PC');
data_PC_GB_mod_4 = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [4.0] Analysis.xlsx', 'Sheet', 'PC');
