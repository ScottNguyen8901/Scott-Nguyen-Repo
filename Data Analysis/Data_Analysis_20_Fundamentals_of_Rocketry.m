...
% Group A data
data_PC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [2.0] Fundamentals of Rocketry.xlsx', 'Sheet', 'PC');
data_MC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [2.0] Fundamentals of Rocketry.xlsx', 'Sheet', 'MC');
data_EC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [2.0] Fundamentals of Rocketry.xlsx', 'Sheet', 'EC');

% Group B data
data_PC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [2.0] Fundamentals of Rocketry.xlsx', 'Sheet', 'PC');
data_MC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [2.0] Fundamentals of Rocketry.xlsx', 'Sheet', 'MC');
data_EC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [2.0] Fundamentals of Rocketry.xlsx', 'Sheet', 'EC');
...
sgtitle('Fundamentals of Rocketry', 'FontSize', 24, 'FontName', 'Times New Roman')
...
ylim([-10, 40]) % Adjust the y-axis limit as needed
legend('Group A', 'Group B', 'FontSize', 24) 

sgtitle('Fundamentals of Rocketry Comparison', 'FontSize', 24, 'FontName', 'Times New Roman')
...
for i = 1:length(time)
    text(time(i), -2, sprintf('\\Delta=%.2f', mean_val_diff_GA(i)), ...
        'HorizontalAlignment', 'center', 'VerticalAlignment', 'bottom', 'FontSize', 14, 'Color', 'b', 'Interpreter', 'tex');
    text(time(i), -4, sprintf('\\Delta=%.2f', mean_val_diff_GB(i)), ...
