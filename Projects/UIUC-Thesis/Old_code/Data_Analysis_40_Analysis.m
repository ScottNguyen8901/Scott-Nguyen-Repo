...
% Group A data
data_PC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [4.0] Analysis.xlsx', 'Sheet', 'PC');
data_MC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [4.0] Analysis.xlsx', 'Sheet', 'MC');
data_EC_GA = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group A\GA [4.0] Analysis.xlsx', 'Sheet', 'EC');

% Group B data
data_PC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [4.0] Analysis.xlsx', 'Sheet', 'PC');
data_MC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [4.0] Analysis.xlsx', 'Sheet', 'MC');
data_EC_GB = readmatrix('G:\My Drive\UIUC\Spring 2024\DodNDEP\Results\Data Analysis\Group B\GB [4.0] Analysis.xlsx', 'Sheet', 'EC');
...
ylim([-15, 20]) % Adjust the y-axis limit as needed
